...
/*datepicker 사용하는 방법
tvYear.setOnLongClickListener(new View.OnLongClickListner(){
    public boolean on LongClick(View v){
        chorno.stop();
        chrono.setTextColor(Color.BLUE):

        tvYear.setText(Integer.toString(dPicker.getYear());
        tvMonth.setText(Integer.totring(1+dPicker.getMonth());
        tvDay.setText(Integer.toString(dPicker.getDayOfMonth()));

        tvHour.setText(Integer.toString(tPicker.getCurrentHour()));
        tvMinute.setText(Integer.toString(tPiker.getCurrentMinute()));
